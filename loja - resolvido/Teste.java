...
//       Mostra resultado final da compra e salário do gerente e do vendedor após venda
        ...
        System.out.println(notaFiscal.getCliente().toString() + " comprou " + notaFiscal.getValorTotal() + " vendedor:  " + notaFiscal.getVendedor().getNome());
        ...
        try {
            escreveRelatorio(notaFiscal);
        }catch (Exception e){
            System.out.println(e);
        }
    }

    public static  void escreveRelatorio(NotaFiscal notaFiscal)
            throws IOException {

        BufferedWriter writer = new BufferedWriter(
                new FileWriter("Relatorio Vendas.txt")
        );
        writer.write("\n--- Nota Fiscal ----\n");
        writer.write(notaFiscal.toString());
